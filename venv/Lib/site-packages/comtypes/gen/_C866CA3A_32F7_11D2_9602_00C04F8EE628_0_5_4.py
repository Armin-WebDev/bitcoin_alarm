...
__all__ = [
    'SPEI_SR_PRIVATE', 'SRTStandard', 'SPPARTOFSPEECH',
    'SVEAllEvents', 'SpeechWordPronounceable', 'DISPID_SVPriority',
    'SPEI_HYPOTHESIS', 'SpeechCategoryAppLexicons', 'SREAdaptation',
    'SPEI_INTERFERENCE', 'SPDKL_LocalMachine',
    'DISPID_SRCEAdaptation', 'SpeechPartOfSpeech',
    'SpeechAllElements', 'DISPID_SpeechVoice',
    'DISPID_SVAudioOutputStream', 'ISpMMSysAudio',
    'ISpeechResourceLoader', 'DISPID_SRRTimes', 'DISPID_SVSPhonemeId',
    'SVPAlert', 'SAFT24kHz16BitMono', 'SPRULESTATE',
    'ISpRecoContext2', 'DISPID_SMSAMMHandle',
    'DISPID_SRGCmdLoadFromObject', 'SP_VISEME_5',
    'DISPID_SGRs_NewEnum', 'DISPID_SVSLastBookmarkId',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPCLangId',
    'DISPID_SpeechAudioBufferInfo', 'SPGRAMMARSTATE',
    'ISpeechAudioBufferInfo', 'SPSFunction',
    'DISPID_SRSNumberOfActiveRules', 'ISpXMLRecoResult',
    'SRADefaultToActive', 'SpeechVoicePriority',
    'ISpeechGrammarRuleState', 'STCAll', 'DISPID_SRGRules',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SPPsItem',
    'eLEXTYPE_PRIVATE4', 'SAFTNonStandardFormat',
    'DISPID_SPRulesCount', 'SpObjectTokenCategory',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SLPsItem', 'SVSFDefault',
    'SAFT48kHz8BitStereo', 'Speech_Max_Word_Length',
    'SPRST_NUM_STATES', 'DISPID_SVSkip', 'SDTAudio',
    'SAFT11kHz8BitMono', 'ISpeechObjectToken', 'SpStream',
    'SAFT16kHz8BitStereo', 'DISPID_SRGDictationLoad',
    'SpeechRegistryLocalMachineRoot', 'SVP_4', 'DISPID_SOTRemove',
    'DISPID_SRGDictationSetState', 'SVF_Emphasis', 'SP_VISEME_18',
    'SPGS_ENABLED', 'SPBO_PAUSE', 'DISPID_SASCurrentSeekPosition',
    'SASStop', 'DISPID_SGRAddResource', 'DISPID_SPRuleFirstElement',
    'DISPIDSPTSI_SelectionOffset', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpStreamFormatConverter', 'DISPID_SBSWrite', 'ISpPhraseAlt',
    'SPWF_SRENGINE', 'DISPID_SRGCmdSetRuleIdState',
    'SPFM_OPEN_READONLY', 'ISpeechRecoResult2', 'eLEXTYPE_RESERVED7',
    'SRCS_Enabled', 'SPCT_SLEEP', 'SPSHORTCUTPAIR', 'DISPID_SPPId',
    'SPEI_RESERVED5', 'DISPID_SPEAudioSizeTime', 'eLEXTYPE_APP',
    'SPWF_INPUT', 'SVSFPurgeBeforeSpeak', 'SPEI_START_INPUT_STREAM',
    'SPPS_Noun', 'DISPID_SpeechPhraseRule', 'DISPID_SLWsItem',
    'DISPID_SpeechDataKey', 'SP_VISEME_21',
    'DISPIDSPTSI_SelectionLength', 'SAFT16kHz16BitMono',
    'DISPID_SPEsCount', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SRGCmdSetRuleState', 'Speech_Default_Weight',
    'SPWAVEFORMATTYPE', 'SVP_21', 'DISPID_SOTGetStorageFileName',
    'SPCT_COMMAND', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SREPrivate', 'SSFMOpenReadWrite', 'SPPHRASERULE',
    'DISPID_SBSFormat', 'SDTRule', 'SREStateChange',
    'DISPID_SOTCDefault', 'SpeechVisemeType', 'SPRULE', 'SpLexicon',
    'SPEI_PROPERTY_STRING_CHANGE', 'SGDSInactive', 'DISPID_SLPsCount',
    'SVSFNLPSpeakPunc', 'DISPIDSPRG', 'DISPID_SRCEHypothesis',
    'tagSTATSTG', 'SpeechCategoryRecoProfiles',
    'SDA_No_Trailing_Space', 'IInternetSecurityManager',
    'SpeechEngineProperties', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVSInputWordLength', 'DISPID_SPEAudioSizeBytes',
    'SpObjectToken', 'SPEI_RECO_STATE_CHANGE', 'SpeechFormatType',
    'ISpeechVoiceStatus', 'SPFM_CREATE_ALWAYS', 'SPEI_RESERVED1',
    'eLEXTYPE_PRIVATE13', 'DISPID_SVSLastResult',
    'DISPID_SRCEEndStream', 'DISPID_SPISaveToMemory',
    'SAFT11kHz16BitMono', 'DISPID_SASState', 'SpeechRegistryUserRoot',
    'SPSEMANTICERRORINFO', 'SPCS_ENABLED',
    'ISpeechRecoResultDispatch', 'SGDisplay', 'SVP_8',
    'DISPID_SVDisplayUI', 'DISPID_SRCCreateGrammar',
    'DISPID_SGRAddState', 'DISPID_SpeechAudioStatus',
    'SAFT8kHz16BitStereo', 'SGSDisabled', 'SpWaveFormatEx',
    'SpeechGrammarWordType', 'DISPID_SGRSRule',
    'DISPIDSPTSI_ActiveOffset', 'eLEXTYPE_PRIVATE1',
    'SAFT48kHz16BitMono', 'eLEXTYPE_RESERVED4', 'SECFIgnoreKanaType',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechPhraseAlternates',
    'eLEXTYPE_RESERVED9', 'SpeechGrammarState', 'DISPID_SRRAudio',
    'DISPID_SVEEnginePrivate', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SOTCEnumerateTokens', 'ISpeechLexiconPronunciations',
    'ISpeechRecoGrammar', 'SPEVENTENUM', 'SPAR_Medium',
    'DISPID_SVEWord', 'DISPID_SPIRule', 'ISpShortcut',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SpeechTokenKeyUI',
    'SAFT22kHz8BitMono', 'ISpStreamFormat', 'SPPHRASEPROPERTY',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_LETTERTOSOUND',
    'SAFT24kHz16BitStereo', 'SPDKL_CurrentUser', 'DISPID_SLWType',
    'DISPID_SVGetProfiles', 'DISPID_SGRsDynamic',
    'DISPID_SpeechRecognizer', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SRGetFormat', 'SpPhoneConverter', 'DISPID_SDKEnumKeys',
    'DISPID_SMSADeviceId', 'ISpeechObjectTokens', 'SVEWordBoundary',
    'SAFTGSM610_8kHzMono', 'SpeechAudioState', 'SRTReSent',
    'SAFT22kHz16BitStereo', 'SpeechUserTraining',
    'SpeechGrammarRuleStateTransitionType', 'SpeechCategoryAudioIn',
    'DISPID_SRStatus', 'DISPID_SRProfile', 'SPEI_SOUND_START',
    'SPSSuppressWord', 'DISPID_SDKEnumValues', 'DISPID_SCSBaseStream',
    'DISPID_SpeechPhraseProperties', 'SWPUnknownWordPronounceable',
    'DISPID_SGRsCommitAndSave', 'DISPID_SVEViseme',
    'eLEXTYPE_PRIVATE14', 'SPEI_MIN_SR', 'DISPID_SOTCreateInstance',
    'DISPID_SWFESamplesPerSec', 'ISpeechBaseStream',
    'DISPID_SpeechRecoResult', 'SP_VISEME_16',
    'DISPID_SpeechPhraseBuilder', 'SVSFPersistXML',
    'DISPID_SpeechPhraseInfo', 'SPLEXICONTYPE',
    'ISpeechRecoResultTimes', 'SGLexicalNoSpecialChars',
    'DISPID_SPRuleParent', '_RemotableHandle', 'ISequentialStream',
    'SVEViseme', 'SDTAll', 'ISpRecognizer', 'DISPID_SADefaultFormat',
    'SPEI_MIN_TTS', 'SPPS_RESERVED2', 'SpShortcut',
    'DISPID_SPAStartElementInResult', 'DISPID_SVEStreamStart',
    'SPDKL_DefaultLocation', 'SASClosed', 'SPSLMA',
    'ISpeechRecognizer', 'SPCT_SUB_DICTATION', 'DISPID_SPACommit',
    'DISPID_SPANumberOfElementsInResult',
    'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SpeechLexiconWord', 'SPFM_NUM_MODES',
    'SpeechEmulationCompareFlags', 'SPSNotOverriden',
    'DISPID_SGRSTPropertyId', 'SpeechTokenContext', 'DISPID_SRGReset',
    'DISPID_SPPEngineConfidence', 'ISpNotifySource',
    'DISPID_SVSCurrentStreamNumber', 'SPTEXTSELECTIONINFO',
    'DISPID_SWFEFormatTag', 'SPXRO_Alternates_SML', 'ISpPhrase',
    'UINT_PTR', 'DISPID_SPRsCount', 'SPEI_RECOGNITION',
    'SPWORDPRONUNCIATION', 'SGSEnabled', 'DISPID_SLAddPronunciation',
    'DISPID_SLPPartOfSpeech', 'SPGS_EXCLUSIVE',
    'DISPID_SVGetAudioOutputs', 'DISPID_SRSetPropertyString',
    'SpPhoneticAlphabetConverter', 'SpeechRecoEvents',
    'ISpRecoGrammar2', 'DISPID_SGRsAdd', 'SDKLDefaultLocation',
    'eLEXTYPE_PRIVATE12', 'SpeechLexiconType',
    'DISPID_SpeechGrammarRule', 'SPRS_INACTIVE', 'ISpRecoCategory',
    'DISPID_SGRClear', 'DISPID_SVSInputSentencePosition',
    'DISPID_SVESentenceBoundary', 'SPSEMANTICFORMAT',
    'SAFT44kHz16BitMono', 'SPEI_SOUND_END', 'eLEXTYPE_PRIVATE8',
    'SpMMAudioOut', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPLO_DYNAMIC',
    'DISPID_SVEventInterests', 'DISPID_SVIsUISupported',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SGRsFindRule',
    'SpVoice', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SRRTLength', 'DISPID_SPIEnginePrivateData',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SVVoice',
    'SPSHORTCUTPAIRLIST', 'SpeechGrammarTagDictation',
    'DISPID_SOTsCount', 'DISPID_SASCurrentDevicePosition',
    'SECFDefault', 'DISPID_SOTs_NewEnum', 'DISPID_SRAudioInputStream',
    'ISpeechAudioFormat', 'SPEI_PHRASE_START', 'ISpeechCustomStream',
    'SPSHT_NotOverriden', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRState', 'DISPID_SpeechFileStream',
    'DISPID_SDKDeleteKey', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SDKGetBinaryValue', 'DISPID_SMSSetData', 'SPAS_PAUSE',
    'DISPID_SRCEPropertyStringChange', 'DISPIDSPTSI',
    'ISpeechXMLRecoResult', 'SPINTERFERENCE_NONE', 'SPEI_MAX_TTS',
    'DISPID_SFSOpen', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechRecoContextEvents', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SVStatus', 'SRESoundEnd', 'SDA_One_Trailing_Space',
    'SRESoundStart', 'ISpeechPhraseRule', 'SpeechRunState',
    'ISpeechMemoryStream', 'SPEI_MAX_SR', 'DISPID_SRCPause',
    'DISPID_SpeechGrammarRules', 'DISPID_SPIGetDisplayAttributes',
    'SVSFParseMask', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SLWPronunciations', 'DISPID_SLPPhoneIds',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'ISpProperties',
    'DISPID_SRGDictationUnload', 'SAFT16kHz16BitStereo',
    'ISpeechPhraseElements', 'SRTExtendableParse',
    'DISPID_SPERetainedSizeBytes', 'SPPHRASEELEMENT',
    'DISPID_SPPParent', 'SP_VISEME_12', 'DISPID_SPAs_NewEnum',
    'SVP_2', 'ISpRecognizer2', 'SP_VISEME_8', 'SITooFast',
    'DISPID_SGRSTType', 'DISPID_SMSALineId', 'DISPID_SGRSTWeight',
    'ISpeechObjectTokenCategory', 'DISPID_SVSpeakCompleteEvent',
    'eLEXTYPE_PRIVATE19', 'SPWT_LEXICAL', 'DISPID_SOTSetId',
    'DISPID_SpeechPhraseRules', 'SVP_18', 'DISPID_SpeechVoiceEvent',
    'SVSFParseAutodetect', 'DISPID_SpeechRecoResultTimes',
    'SpFileStream', 'DISPID_SRRSaveToMemory', 'DISPID_SGRsItem',
    'SpeechRecoContextState', 'SPPS_Function', 'SPEI_END_SR_STREAM',
    'SREAudioLevel', 'SREStreamStart', 'SREPropertyStringChange',
    'SPRECOSTATE', 'DISPID_SGRAttributes', 'SpeechDiscardType',
    'DISPID_SpeechMMSysAudio', 'DISPID_SVRate', 'ISpAudio',
    'DISPID_SRGSetTextSelection', 'SpAudioFormat',
    'DISPID_SpeechAudioFormat', 'SAFT11kHz8BitStereo',
    'SpeechGrammarTagWildcard', 'SpMemoryStream', 'STSF_FlagCreate',
    'ISpeechLexiconWords', 'SBONone', 'ISpeechFileStream',
    'DISPID_SOTCategory', 'SGRSTTRule', 'eLEXTYPE_PRIVATE9',
    'ISpeechPhraseElement', 'DISPID_SGRName', 'SP_VISEME_4',
    'SPPS_LMA', 'DISPID_SRSAudioStatus', 'DISPID_SPPFirstElement',
    'SPSNoun', 'SpeechTokenValueCLSID', 'SP_VISEME_13', 'SP_VISEME_1',
    'DISPID_SDKSetLongValue', 'SASPause', 'DISPID_SGRsCommit',
    'eLEXTYPE_PRIVATE2', 'SPADAPTATIONRELEVANCE', 'DISPID_SVSpeak',
    'DISPID_SGRSTText', 'SPINTERFERENCE_TOOLOUD',
    'SAFTADPCM_44kHzMono', 'SRADynamic',
    'DISPID_SpeechPhraseProperty', 'SLOStatic',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPILanguageId',
    'SGRSTTWord', 'SpeechBookmarkOptions', 'SVP_11',
    'SDKLCurrentUser', 'DISPID_SPIReplacements',
    'DISPID_SpeechRecoContext', 'ISpeechLexiconWord',
    'DISPID_SRCRecognizer', 'SLODynamic', 'SVP_12',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRRAudioFormat',
    'DISPID_SDKGetStringValue', 'DISPID_SPPConfidence',
    'DISPID_SOTCId', 'SP_VISEME_17',
    'ISpeechGrammarRuleStateTransitions', 'SAFT32kHz16BitMono',
    'DISPID_SASetState', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SRCRequestedUIType',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFTADPCM_11kHzMono',
    'ISpRecoGrammar', 'DISPID_SGRSTPropertyName', 'SDTProperty',
    'SREAllEvents', 'SPCATEGORYTYPE', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SLWs_NewEnum', 'DISPID_SVAlertBoundary', 'SPEI_RESERVED6',
    'DISPID_SPRuleNumberOfElements', 'SpeechTokenShellFolder',
    'DISPID_SRCResume', 'SAFT12kHz8BitStereo',
    'DISPID_SDKGetlongValue', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechMemoryStream', 'SP_VISEME_3', 'DISPID_SVEBookmark',
    'SPWORDTYPE', 'DISPID_SLGenerationId', 'ISpeechWaveFormatEx',
    'DISPID_SGRSTRule', 'SPRECOGNIZERSTATUS', 'SVP_15',
    'ISpeechAudio', 'Speech_StreamPos_Asap', 'SPEI_FALSE_RECOGNITION',
    'SPBO_TIME_UNITS', 'DISPID_SABufferNotifySize',
    'DISPID_SDKCreateKey', 'STSF_CommonAppData', 'SPEVENT',
    'SPAS_STOP', 'SVP_9', 'ISpObjectWithToken', 'SPPS_SuppressWord',
    'eLEXTYPE_PRIVATE6', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'STCInprocServer', 'DISPID_SGRSTsCount',
    'DISPID_SOTGetDescription', 'SAFT16kHz8BitMono',
    'SpeechAudioFormatGUIDText', 'SPVPRI_OVER',
    'SGDSActiveUserDelimited', '_SPAUDIOSTATE', 'SDKLLocalMachine',
    'DISPID_SRGIsPronounceable', 'DISPID_SPEs_NewEnum',
    'DISPID_SAEventHandle', 'DISPID_SpeechGrammarRuleState',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPRuleId', 'SpNotifyTranslator',
    'SPINTERFERENCE_TOOSLOW', 'SPAS_RUN',
    'DISPID_SPEEngineConfidence', 'DISPID_SPRuleConfidence', 'SVP_6',
    'SSSPTRelativeToEnd', 'WAVEFORMATEX',
    'DISPID_SPEActualConfidence', 'SPPS_Interjection', 'SPFILEMODE',
    'SPLO_STATIC', 'eWORDTYPE_DELETED', 'SAFTCCITT_uLaw_44kHzStereo',
    'DISPID_SGRSAddRuleTransition', 'SP_VISEME_20',
    'DISPID_SVSInputWordPosition', 'DISPID_SVSRunningState',
    'IEnumSpObjectTokens', 'SVEBookmark', 'eLEXTYPE_PRIVATE3',
    'SpeechTokenKeyAttributes', 'DISPID_SABIEventBias',
    'SRERequestUI', 'SREStreamEnd', 'DISPID_SPRulesItem',
    'DISPID_SRRGetXMLErrorInfo', 'SAFT12kHz16BitStereo',
    'SPWORDPRONOUNCEABLE', 'SDTLexicalForm', 'SPEI_RESERVED3',
    'SPCS_DISABLED', 'SGDSActive', 'STCInprocHandler',
    'SPRST_INACTIVE', 'SpCompressedLexicon', 'DISPID_SPPName',
    'SP_VISEME_2', 'DISPID_SRGState', 'ISpGrammarBuilder',
    'SPFM_CREATE', 'ISpeechRecognizerStatus', 'SpeechCategoryVoices',
    'DISPID_SpeechObjectToken', 'Speech_Max_Pron_Length',
    'SAFT22kHz16BitMono', 'SpeechAudioFormatType',
    '__MIDL_IWinTypes_0009', 'DISPID_SGRSTPropertyValue',
    'ISpeechMMSysAudio', 'DISPID_SWFEAvgBytesPerSec',
    'eLEXTYPE_PRIVATE10', 'SAFTADPCM_22kHzStereo', 'SRAExport',
    'DISPID_SRCESoundEnd', 'ISpResourceManager', 'SPWORD', 'SVP_10',
    'SVP_19', 'DISPID_SRGId', 'SPPS_Noncontent',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVEStreamEnd',
    'DISPID_SRGCmdLoadFromMemory', 'SECLowConfidence',
    'DISPID_SRCState', 'SPCT_DICTATION', 'SP_VISEME_6', 'SPSMF_UPS',
    'SPEI_TTS_PRIVATE', 'SRSActiveAlways',
    '_ISpeechRecoContextEvents', 'DISPID_SASFreeBufferSpace',
    'SAFT44kHz8BitMono', 'SpeechRecognizerState', 'SVPNormal',
    'SPVISEMES', 'DISPID_SPIAudioSizeTime', 'DISPID_SGRsCount',
    'DISPID_SVSInputSentenceLength', 'ISpEventSink',
    'SpeechPropertyAdaptationOn', 'DISPID_SPRFirstElement',
    'DISPID_SGRId', 'SPSMF_SAPI_PROPERTIES', 'DISPID_SABufferInfo',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRRPhraseInfo',
    'SVEStartInputStream', 'SINoise', 'SpCustomStream',
    'SVEAudioLevel', 'SPSUnknown', 'SPRST_ACTIVE', 'SPPS_RESERVED1',
    'SpMMAudioEnum', 'eLEXTYPE_MORPHOLOGY', 'SPWT_DISPLAY',
    'DISPID_SPAsItem', 'SP_VISEME_0',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'IEnumString',
    'SDA_Two_Trailing_Spaces', 'SVEPrivate', 'SGRSTTTextBuffer',
    'DISPID_SpeechRecoResult2', 'DISPID_SRCEInterference',
    'DISPID_SRRSetTextFeedback', 'DISPID_SPPsCount', 'SITooLoud',
    'DISPID_SRCRetainedAudio', 'DISPID_SPCPhoneToId',
    'SpeechAddRemoveWord', 'Speech_StreamPos_RealTime', 'SLTUser',
    'ISpeechGrammarRuleStateTransition', 'SDTPronunciation',
    'DISPID_SRCEEnginePrivate', 'SWTAdded', 'SpeechTokenKeyFiles',
    'SVSFIsFilename', 'SPSHT_EMAIL', 'DISPID_SAStatus',
    'ISpeechLexicon', 'ISpObjectToken', 'DISPID_SRGRecoContext',
    'SPEI_PHONEME', 'SPEI_SR_AUDIO_LEVEL', 'SPEI_WORD_BOUNDARY',
    'SPINTERFERENCE', 'DISPID_SAVolume', 'SECHighConfidence',
    'STCLocalServer', 'SPEI_TTS_AUDIO_LEVEL', 'SREBookmark',
    'SRSEIsSpeaking', 'SAFT8kHz8BitStereo',
    'DISPID_SpeechGrammarRuleStateTransition',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SRAudioInput',
    'SRAInterpreter', 'tagSPPROPERTYINFO', 'SPPS_Verb',
    'SPPS_Unknown', 'SRTAutopause', 'DISPID_SLGetGenerationChange',
    'SWPKnownWordPronounceable', 'DISPID_SPPs_NewEnum',
    'DISPID_SVPause', 'SPCT_SUB_COMMAND',
    'DISPID_SOTMatchesAttributes', 'SPEI_SR_BOOKMARK', 'SVP_7',
    'SAFT32kHz8BitMono', 'SpeechMicTraining', 'SpeechAudioVolume',
    'ISpRecognizer3', 'DISPID_SRGCommit', 'SSFMCreateForWrite',
    'SPINTERFERENCE_NOISE', 'SAFT32kHz8BitStereo',
    'DISPID_SpeechAudio', 'DISPID_SVSVisemeId',
    'DISPID_SPEDisplayText', 'SRTEmulated', 'SSTTTextBuffer',
    'ISpPhoneticAlphabetConverter', 'SVSFIsXML',
    'SAFTCCITT_ALaw_44kHzMono', 'SpSharedRecoContext',
    'SpeechDictationTopicSpelling', 'SFTInput', 'SpeechInterference',
    'ISpPhoneticAlphabetSelection', 'SGPronounciation',
    'ISpeechDataKey', 'eLEXTYPE_PRIVATE16', 'SpeechEngineConfidence',
    'SAFT24kHz8BitStereo', 'SPSERIALIZEDPHRASE', 'SDTReplacement',
    'SVF_Stressed', 'DISPID_SRGCmdLoadFromFile', 'SGSExclusive',
    'DISPID_SWFEBlockAlign', 'SPSHT_Unknown', 'DISPID_SRRTTickCount',
    'SECFIgnoreWidth', 'DISPID_SpeechCustomStream',
    'DISPID_SPRuleChildren', 'SPEI_ADAPTATION', 'SpPhraseInfoBuilder',
    'SSFMCreate', 'DISPID_SGRSTransitions', 'DISPID_SLPType',
    'SECFIgnoreCase', 'DISPID_SRGetRecognizers', 'SAFT24kHz8BitMono',
    'DISPID_SRCERecognitionForOtherContext', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRSCurrentStreamPosition', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SpeechLexicon',
    'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SpeechPhraseElement', 'eLEXTYPE_PRIVATE11', 'SRAONone',
    'SPCONTEXTSTATE', 'SPRST_INACTIVE_WITH_PURGE', 'SpeechWordType',
    'DISPID_SGRSAddWordTransition', 'DISPID_SRCEFalseRecognition',
    'eLEXTYPE_USER_SHORTCUT', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPAPhraseInfo', 'SAFT22kHz8BitStereo', 'DISPID_SBSRead',
    'DISPID_SLPs_NewEnum', 'SGLexical', 'DISPID_SAFGuid',
    'ISpLexicon', 'SPEI_PROPERTY_NUM_CHANGE', 'SRTSMLTimeout',
    'SRERecognition', 'SAFTCCITT_uLaw_44kHzMono', 'SpeechLoadOption',
    'ISpeechPhraseAlternate', 'DISPID_SLRemovePronunciation',
    'DISPID_SVSLastStreamNumberQueued', 'SRAORetainAudio',
    'DISPID_SLWsCount', 'ISpPhoneConverter', 'SVSFlagsAsync',
    'DISPID_SPPValue', 'DISPID_SABIMinNotification',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SASNonBlockingIO',
    'DISPID_SRGetPropertyNumber', 'ISpVoice', 'ISpNotifySink',
    'DISPID_SPIStartTime', 'DISPID_SRRSpeakAudio', 'SPEI_RESERVED2',
    'SPVOICESTATUS', 'DISPID_SGRInitialState',
    'DISPID_SRRTOffsetFromStart', 'SP_VISEME_14',
    'DISPID_SRGetPropertyString', 'SpeechRecoProfileProperties',
    'SVP_20', 'DISPID_SPPChildren', 'SP_VISEME_7', 'SPBO_AHEAD',
    'SAFT8kHz16BitMono', 'SPBO_NONE', 'SPINTERFERENCE_NOSIGNAL',
    'SDTAlternates', 'DISPID_SPIGrammarId', 'SFTSREngine',
    'SAFTCCITT_ALaw_8kHzStereo', 'eLEXTYPE_PRIVATE20', 'SPVPRI_ALERT',
    'SINone', 'SREFalseRecognition', 'DISPID_SPERequiredConfidence',
    'SSSPTRelativeToCurrentPosition', 'SVSFParseSsml', 'SRSEDone',
    'SpeechTokenIdUserLexicon', 'DISPID_SRCEStartStream',
    'SAFT32kHz16BitStereo', 'DISPID_SRIsShared',
    'SpInProcRecoContext', 'SP_VISEME_19', 'STSF_AppData',
    'DISPID_SRRRecoContext', 'DISPID_SpeechPhraseReplacements',
    'SVP_5', 'SPAO_NONE', 'SVSFUnusedFlags', 'DISPID_SVVolume',
    'SVP_1', 'ISpeechVoice', 'SPAR_Unknown', 'SECNormalConfidence',
    'SPAUDIOSTATE', 'SAFT11kHz16BitStereo', 'SPAR_Low',
    'DISPID_SRRDiscardResultInfo', 'ISpeechPhraseInfoBuilder',
    'ISpRecoContext', 'SP_VISEME_15', 'SPINTERFERENCE_TOOQUIET',
    'SAFT48kHz16BitStereo', 'DISPID_SVResume',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRSClsidEngine',
    'SREPhraseStart', 'STSF_LocalAppData', 'SPAR_High',
    'DISPID_SRCEBookmark', 'ISpNotifyTranslator', 'SVP_14',
    'eLEXTYPE_PRIVATE18', 'SSSPTRelativeToStart', 'SPBOOKMARKOPTIONS',
    'DISPID_SOTIsUISupported', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpeechGrammarRules', 'DISPID_SLWLangId',
    'ISpeechPhraseReplacement', 'SPEI_REQUEST_UI', 'DISPID_SLWWord',
    'SREPropertyNumChange', 'SPWORDLIST', 'DISPID_SRCEAudioLevel',
    'SPBINARYGRAMMAR', 'DISPID_SWFEBitsPerSample', 'SPXRO_SML',
    'SGRSTTEpsilon', 'SVSFParseSapi', 'DISPID_SVSpeakStream',
    'DISPID_SPEsItem', 'SpSharedRecognizer', 'SRAImport',
    'SP_VISEME_11', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPSModifier', 'ISpRecoResult', 'ISpStream', 'DISPID_SVGetVoices',
    'SpUnCompressedLexicon', 'ISpeechLexiconPronunciation',
    'SPGS_DISABLED', 'DISPID_SOTCGetDataKey', 'SVSFVoiceMask',
    'SSTTDictation', 'SPXMLRESULTOPTIONS', 'SAFT8kHz8BitMono',
    'SECFNoSpecialChars', 'SVP_16', 'DISPID_SRSCurrentStreamNumber',
    'SAFTText', 'SDTDisplayText', 'SREInterference',
    'DISPID_SVEPhoneme', 'SpeechCategoryRecognizers',
    'SpInprocRecognizer', 'SP_VISEME_10', 'DISPID_SABIBufferSize',
    'DISPID_SPIEngineId', 'SAFTADPCM_8kHzStereo',
    'ISpeechPhraseRules', 'SBOPause', 'SAFTCCITT_uLaw_8kHzMono',
    'SRSActive', 'SPPS_Modifier', 'SVF_None', 'SAFTDefault',
    'SWPUnknownWordUnpronounceable', 'DISPID_SOTDataKey',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SLPLangId',
    'SpeechRuleState', 'ISpeechRecoResult', 'SGRSTTWildcard',
    'SAFTNoAssignedFormat', 'SRSInactive', 'DISPID_SDKSetStringValue',
    'DISPID_SPRules_NewEnum', 'SVSFNLPMask', 'DISPID_SVSLastBookmark',
    'DISPID_SRCEPhraseStart', 'SAFTGSM610_11kHzMono',
    'DISPID_SPCIdToPhone', 'ISpeechRecoContext', 'SPSHORTCUTTYPE',
    'SpeechDataKeyLocation', 'DISPID_SPRNumberOfElements',
    'SAFTCCITT_ALaw_11kHzMono', 'SAFTCCITT_uLaw_22kHzMono',
    'SAFT12kHz8BitMono', 'DISPID_SRCVoice', 'SPSERIALIZEDRESULT',
    'SpeechDisplayAttributes', 'SpeechRetainedAudioOptions',
    'SpeechPropertyLowConfidenceThreshold', 'SPLOADOPTIONS',
    'SPRECORESULTTIMES', 'DISPID_SLPSymbolic', 'DISPID_SPRuleName',
    'DISPID_SPIRetainedSizeBytes', 'SPSVerb', 'SREHypothesis',
    'ISpeechAudioStatus', 'SPEI_VOICE_CHANGE',
    'SAFTCCITT_ALaw_22kHzStereo', 'SRCS_Disabled', 'SITooSlow',
    'SVEEndInputStream', 'DISPID_SOTId', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SLGetPronunciations', 'SECFEmulateResult',
    'SAFT12kHz16BitMono', 'DISPID_SOTsItem', 'DISPID_SVEVoiceChange',
    'SVESentenceBoundary', 'DISPID_SpeechPhraseReplacement',
    'SPAUDIOBUFFERINFO', 'DISPID_SRCERequestUI',
    'DISPID_SRCCreateResultFromMemory', 'ISpeechPhraseReplacements',
    'SINoSignal', 'ISpeechPhraseProperty',
    'DISPID_SPPNumberOfElements', 'SVP_13', 'SRATopLevel',
    'SVEPhoneme', 'SPPS_RESERVED3', 'IStream', 'SAFTGSM610_22kHzMono',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechPhraseElements', 'DISPID_SGRSTNextState',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SRCEventInterests',
    'SSFMOpenForRead', 'DISPID_SDKOpenKey', 'SPPHRASE',
    'DISPID_SPAsCount', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPGRAMMARWORDTYPE', 'DISPID_SpeechBaseStream', 'SpMMAudioIn',
    'SAFTGSM610_44kHzMono', 'DISPID_SRIsUISupported',
    'SpeechVoiceSpeakFlags', 'SPEI_START_SR_STREAM',
    'SAFTExtendedAudioFormat', 'SPEI_VISEME',
    'DISPID_SPRDisplayAttributes', 'SLTApp',
    'DISPID_SRGSetWordSequenceData', 'ISpeechPhraseInfo',
    'DISPID_SVAudioOutput', 'DISPID_SDKDeleteValue',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPIAudioSizeBytes',
    'SpeechPropertyResponseSpeed', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPIProperties', 'SAFTADPCM_11kHzStereo',
    '_ISpeechVoiceEvents', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SRCRetainedAudioFormat', 'SGDSActiveWithAutoPause',
    'SpTextSelectionInformation', 'SpeechVisemeFeature',
    'SAFTADPCM_22kHzMono', 'DISPID_SVGetAudioInputs', 'LONG_PTR',
    'DISPID_SPEPronunciation', 'DISPID_SPELexicalForm',
    'DISPID_SAFGetWaveFormatEx', 'SPAO_RETAIN_AUDIO',
    'DISPID_SRCBookmark', 'DISPID_SMSGetData', 'SPPROPERTYINFO',
    'SPFM_OPEN_READWRITE', 'ISpeechGrammarRule',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRCSetAdaptationData',
    'DISPID_SPEDisplayAttributes',
    'SpeechGrammarTagUnlimitedDictation', 'SPSHT_OTHER',
    'SpeechVoiceEvents', 'SRARoot', 'SRERecoOtherContext',
    'SpeechAudioProperties', 'SPDATAKEYLOCATION',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SPRText',
    'DISPIDSPTSI_ActiveLength', 'SpeechPropertyResourceUsage',
    'eWORDTYPE_ADDED', 'SITooQuiet', 'SP_VISEME_9',
    'SPRECOCONTEXTSTATUS', 'SWTDeleted',
    'DISPID_SREmulateRecognition', 'DISPID_SBSSeek',
    'DISPID_SGRSAddSpecialTransition', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPARecoResult', 'ISpeechTextSelectionInformation',
    'SPWORDPRONUNCIATIONLIST', 'SpResourceManager', 'SASRun',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRCreateRecoContext',
    'ISpObjectTokenCategory', 'DISPID_SPIGetText',
    'SPEI_END_INPUT_STREAM', 'DISPID_SRDisplayUI',
    'SpeechSpecialTransitionType', 'SPRST_ACTIVE_ALWAYS',
    'SpeechRuleAttributes', 'SPSTREAMFORMATTYPE', 'ISpEventSource',
    'DISPID_SOTCSetId', 'DISPID_SPRsItem', 'DISPID_SRCESoundStart',
    'SAFT44kHz16BitStereo', 'SDKLCurrentConfig', 'eLEXTYPE_PRIVATE17',
    'SpeechPropertyHighConfidenceThreshold', 'SPDKL_CurrentConfig',
    'ISpeechPhraseProperties', 'SPRS_ACTIVE', 'ISpDataKey',
    'DISPID_SFSClose', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRSetPropertyNumber', 'SpeechStreamSeekPositionType',
    'SVP_0', 'DISPID_SOTGetAttribute', 'SPAUDIOSTATUS',
    'SpeechCategoryPhoneConverters', 'SVP_3',
    'IInternetSecurityMgrSite', 'SVP_17', 'DISPID_SVWaitUntilDone',
    'SPSInterjection', 'SPWT_PRONUNCIATION', 'SSTTWildcard',
    'SPEI_UNDEFINED', 'SPVPRIORITY', 'DISPID_SpeechLexiconWords',
    'SVSFIsNotXML', 'DISPID_SPERetainedStreamOffset', 'SVPOver',
    'DISPID_SPRs_NewEnum', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRCERecognition', 'eLEXTYPE_USER', 'SpeechStreamFileMode',
    'SPEVENTSOURCEINFO', 'eLEXTYPE_RESERVED8', 'DISPID_SVEAudioLevel',
    'SPAUDIOOPTIONS', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpStreamFormatConverter', 'DISPID_SLGetWords',
    'DISPID_SRRGetXMLResult', 'DISPID_SWFEChannels',
    'DISPID_SRRecognizer', 'DISPID_SRSSupportedLanguages',
    'eLEXTYPE_RESERVED6', 'eLEXTYPE_RESERVED10', 'SVEVoiceChange',
    'SAFT48kHz8BitMono', 'SRSInactiveWithPurge',
    'DISPID_SRRTStreamTime', 'DISPID_SAFType', 'SGRSTTDictation',
    'DISPID_SRRAlternates', 'DISPID_SpeechObjectTokenCategory',
    'SPAS_CLOSED', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SpeechPhoneConverter', 'SPPS_RESERVED4',
    'SAFTADPCM_8kHzMono', 'DISPID_SPIElements',
    'DISPID_SpeechLexiconProns', 'STCRemoteServer',
    'ISpeechPhoneConverter', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SGRSTsItem', 'DISPID_SOTDisplayUI', 'SPEI_TTS_BOOKMARK',
    'SPPS_NotOverriden', 'SpeechCategoryAudioOut',
    'DISPID_SpeechObjectTokens', 'SPVPRI_NORMAL',
    'DISPID_SWFEExtraData', 'SpNullPhoneConverter',
    'eLEXTYPE_PRIVATE7', 'DISPID_SpeechLexiconPronunciation',
    'SpeechRecognitionType', 'ISpSerializeState',
    'DISPID_SDKSetBinaryValue'
]

_check_version('1.1.14', 1655726012.317291)
